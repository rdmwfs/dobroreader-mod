...
import org.anonymous.dobrochan.activity.DobroPostsList;
...
public class DobroLinkSpan extends ClickableSpan {
	...
	public DobroLinkSpan(CharSequence board, CharSequence thread, CharSequence post, Context context, DobroPost parent) {
		super();
		this.board = board;
		this.post = post;
	...
	public DobroLinkSpan(CharSequence board, CharSequence post, Context context, DobroPost parent) {
		super();
		this.board = board;
		this.post = post;
		this.context = context;
	...
	public void onClick(View widget) {
		...
		i.putExtra(GDActivity.GD_ACTION_BAR_TITLE, String.format(">>%s/%s",
							board, post));
