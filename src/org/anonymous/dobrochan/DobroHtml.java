...
class HtmlToSpannedConverter implements ContentHandler {
    ...
    public HtmlToSpannedConverter(
            String source, DobroHtml.ImageGetter imageGetter, DobroHtml.TagHandler tagHandler,
            Parser parser) {
        mSource = source;
    ...
    private static void startImg(SpannableStringBuilder text,
        ...
        if (d == null) {
            d = Resources.getSystem().
                    getDrawable(android.R.drawable.ic_secure); //FIXME: random image
    ...
    private static void startBq(SpannableStringBuilder text, Attributes attributes) {
        String depth = attributes.getValue("", "depth");
        if(depth == null || depth.length() == 0)
        	depth = "0";

        int len = text.length();
        text.setSpan(new Blockquote(depth), len, len, Spannable.SPAN_MARK_MARK);
    }
    ...
    private static void endBq(SpannableStringBuilder text) {
        ...
        if (where != len) {
        	...
        	default:
                ...
                text.setSpan(s, where, len,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        }
    }
