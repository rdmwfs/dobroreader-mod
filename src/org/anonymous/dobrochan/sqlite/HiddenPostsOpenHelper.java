...
public class HiddenPostsOpenHelper extends SQLiteOpenHelper implements
		IHiddenPosts {
	...
	private static final String TABLE_CREATE = "CREATE TABLE " + TABLE_NAME
			+ " (" + KEY_COLUMN + " TEXT UNIQUE, " + DATA_COLUMN + " TEXT);";
	...
	public HiddenPostsOpenHelper(Context context) {
		super(context, (Build.VERSION.SDK_INT > 7 ? ApiWrapper
				...
				+ "hidden_posts.sqlite", null, DATABASE_VERSION);
	}
	 ...
	 * 
	 * @see
	 * org.anonymous.dobrochan.sqlite.IHiddenPosts#hidePost(java.lang.String)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.anonymous.dobrochan.sqlite.IHiddenPosts#getComment(java.lang.String)
	 */
	@Override
	public String getComment(String adress) {
		SQLiteDatabase db = getReadableDatabase();
		Cursor c = db.query(TABLE_NAME, GET_COLUMNS, KEY_COLUMN + " = '"
	 ...
	 * 
	 * @see
	 * org.anonymous.dobrochan.sqlite.IHiddenPosts#unhidePost(java.lang.String)
	 */
	@Override
