...
public class ThreadsInfoCacheOpenHelper extends SQLiteOpenHelper implements IThreadsInfoCache {
	...
	/* (non-Javadoc)
	 * @see org.anonymous.dobrochan.sqlite.IThreadsInfoCache#addThreadInfo(java.lang.String, java.lang.String)
	 */
	@Override
	public void addThreadInfo(String adress, 
			String data) {
	...
	/* (non-Javadoc)
	 * @see org.anonymous.dobrochan.sqlite.IThreadsInfoCache#getThreadInfo(java.lang.String)
	 */
	@Override
	public String getThreadInfo(String adress) {
		Cursor c = db.query(TABLE_NAME,
				GET_COLUMNS,
				THREAD_COLUMN+" = '"+adress+"'",
				null,
				null,
				null,
				null,
	...
	/* (non-Javadoc)
	 * @see org.anonymous.dobrochan.sqlite.IThreadsInfoCache#deleteThreadInfo(java.lang.String)
	 */
	@Override
