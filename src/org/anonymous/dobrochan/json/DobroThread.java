...
public class DobroThread implements Comparable<DobroThread>{
	...
	@SerializedName(DobroConstants.THREAD_MODIFIED) private boolean ThreadModified;
	@SerializedName(DobroConstants.LAST_MOD) private String LastModifiedHeader;
	...
	public int compareTo(DobroThread another) {
		DobroThread t2 = (DobroThread)another;
